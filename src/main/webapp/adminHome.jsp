        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" actions="addNewStudent.jsp" method="post">
...
%>
    ...
    <hr class="new1">
  <center><h5>
Designed & Developed  subhasis nanda</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ subhasis nanda</h5></center> 
  <hr class="new1">
<br>
</body>
</html>